...
export function InstagramCarousel() {
  ...
  return (
    <section className="py-20 bg-[#fafafa] overflow-hidden border-b border-gold/10">
      ...
      <div className="relative" ref={emblaRef}>
        <div className="flex gap-6 px-4 sm:px-6 lg:px-8">
          {posts.map((post) => (
            <div
              key={post.id}
              className="flex-[0_0_300px] sm:flex-[0_0_350px] bg-white rounded-xl overflow-hidden border border-[#dbdbdb] shadow-sm mb-10"
            >
              {/* Header */}
              ...
              <div className="p-4 bg-white">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <Heart className="w-6 h-6 text-[#262626] hover:text-red-500 transition-colors cursor-pointer" />
                    <MessageCircle className="w-6 h-6 text-[#262626] hover:text-gold transition-colors cursor-pointer" />
                    <Send className="w-6 h-6 text-[#262626] hover:text-gold transition-colors cursor-pointer" />
                  </div>
                  <Bookmark className="w-6 h-6 text-[#262626] hover:text-gold transition-colors cursor-pointer" />
                </div>

                {/* Caption */}
                <div className="text-sm leading-relaxed text-[#262626]">
                  <span className="font-bold mr-2 text-[#262626]">nobleclinic</span>
                  {post.caption}
                </div>
              </div>
            </div>
